namespace L08 {
    ...
    let colors1: string[] = ["black", "	Brown", "Chocolate", "Maroon"];
    let colors2: string[] = ["Teal", "MediumAquamarine", "	PaleGreen", "	PowderBlue"];

    let randomC1: number = Math.floor(Math.random() * colors1.length);
    let random2C1: number = Math.floor(Math.random() * colors1.length);

    let randomC2: number = Math.floor(Math.random() * colors2.length);
    let random2C2: number = Math.floor(Math.random() * colors2.length);
    ...
    function drawCornerCircles(_position: Vector): void {

        for (let index: number = 0; index < 20; index++) {


            let r2: number = Math.floor(Math.random() * 1000);
    ...
    function drawEllipseAndCurve(): void {
    ...
    function drawAnotherObject(): void {
        crc2.strokeStyle = colors2[randomC2];
        crc2.save();
        crc2.beginPath();
        crc2.lineWidth = Math.floor(Math.random() * 30);
    ...
    function drawSmallCircles(_position: Vector, _size: Vector): void {
        ...
        let radiusParticle: number = Math.floor(Math.random() * 20);
